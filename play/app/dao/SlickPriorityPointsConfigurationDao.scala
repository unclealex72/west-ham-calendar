...
/**
  ...
  */
class SlickPriorityPointsConfigurationDao @Inject() (val dbConfigFactory: DatabaseConfigFactory, implicit val ec: ExecutionContext) extends PriorityPointsConfigurationDao with Slick {
