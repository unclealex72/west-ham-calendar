 ...
 *
 */
public class TicketCalendarsPresenter extends CalendarsPresenter {

	@Inject
	public TicketCalendarsPresenter(Display display, AsyncCallbackExecutor asyncCallbackExecutor,
			CalendarPresenterFactory calendarPresenterFactory) {
		super(display, asyncCallbackExecutor, calendarPresenterFactory, true);
	}
}
