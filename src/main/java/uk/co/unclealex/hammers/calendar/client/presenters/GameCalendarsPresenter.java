 ...
 *
 */
public class GameCalendarsPresenter extends CalendarsPresenter {

	@Inject
	public GameCalendarsPresenter(Display display, AsyncCallbackExecutor asyncCallbackExecutor,
			CalendarPresenterFactory calendarPresenterFactory) {
		super(display, asyncCallbackExecutor, calendarPresenterFactory, false);
	}
}
