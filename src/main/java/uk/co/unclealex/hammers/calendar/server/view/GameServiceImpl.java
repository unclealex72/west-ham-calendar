...
import uk.co.unclealex.hammers.calendar.server.dates.DateTimeImplicits;
...
public class GameServiceImpl implements GameService {
  ...
  protected Function<Game, GameView> createGameViewFunction(final boolean enabled) {
    ...
    return new Function<uk.co.unclealex.hammers.calendar.server.model.Game, GameView>() {
      @Override
      public GameView apply(final uk.co.unclealex.hammers.calendar.server.model.Game game) {
        Date ticketDate;
