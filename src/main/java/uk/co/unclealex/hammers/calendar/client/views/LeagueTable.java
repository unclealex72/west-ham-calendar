 ...
 *
 */
public class LeagueTable extends Table<LeagueRow, LeagueTableRow, LeagueTableRowFactory> implements Display {

  @UiTemplate("Table.ui.xml")
	public interface Binder extends UiBinder<Widget, LeagueTable> {
	}
	
	private static final Binder binder = GWT.create(Binder.class);

	@Inject
	public LeagueTable(LeagueTableRowFactory tableRowFactory) {
