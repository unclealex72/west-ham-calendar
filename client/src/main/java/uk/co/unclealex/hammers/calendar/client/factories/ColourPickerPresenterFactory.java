 ...
 *
 */
public interface ColourPickerPresenterFactory {

	public ColourPickerPresenter createColourPickerPresenter(CalendarColour calendarColour, CalendarColour[] usedCalendarColours);
}
