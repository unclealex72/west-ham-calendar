 ...
 *
 */
public class TeamTableRow extends AbstractGameTableRow {
  ...
  @UiTemplate("TeamTableRow.ui.xml")
	 ...
	 */
	@Inject
	public TeamTableRow(@Assisted GameView gameView, HammersMessages hammersMessages) {
	...
	protected String formatDatePlayed(Date datePlayed) {
		return getHammersMessages().fullDatePlayed(datePlayed);
	}
