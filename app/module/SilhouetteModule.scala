...
import security.Definitions.{AuthenticatorType, Env, Auth, UserType}
import security.models.User
import security.models.daos._
import security.models.services.{UserServiceImpl, UserService}
...
class SilhouetteModule extends ScalaModule {
  ...
  def provideEnvironment(
                          ...
                          authenticatorService: AuthenticatorService[AuthenticatorType],
                          eventBus: EventBus): Env = {

    Environment[UserType, AuthenticatorType](
      userService,
